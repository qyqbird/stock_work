...
def initialize(context):
    ...
    context.short_ema_trans = EMA(timeperiod=8)
    context.long_ema_trans = EMA(timeperiod=20)
...
if __name__ == '__main__':
    ...
    print 
    algo = TradingAlgorithm(initialize=initialize, handle_data=handle_data)#identifiers=['yygf']
